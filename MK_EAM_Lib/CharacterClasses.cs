namespace MK_EAM_Lib
{
    public static class CharacterClassesUtil
    {
        ...
        public static readonly System.Collections.Generic.Dictionary<CharClasses, CharacterStats> dicCharClassToMaxStats = new System.Collections.Generic.Dictionary<CharClasses, CharacterStats>()
        {
            ...
            {CharClasses.Archer, new CharacterStats()       { maxHP = 700, maxMP = 252, atk = 75, def = 25, spd = 55, dex = 50, vit = 40, wis = 50 } },
            ...
            {CharClasses.Assassin, new CharacterStats()     { maxHP = 720, maxMP = 305, atk = 65, def = 25, spd = 65, dex = 75, vit = 40, wis = 60 } },
            {CharClasses.Necromancer, new CharacterStats()  { maxHP = 670, maxMP = 385, atk = 75, def = 25, spd = 50, dex = 60, vit = 40, wis = 75 } },
            {CharClasses.Huntress, new CharacterStats()     { maxHP = 700, maxMP = 305, atk = 65, def = 25, spd = 50, dex = 60, vit = 40, wis = 50 } },
            ...
            {CharClasses.Sorcerer, new CharacterStats()     { maxHP = 670, maxMP = 385, atk = 75, def = 25, spd = 60, dex = 65, vit = 75, wis = 60 } },
