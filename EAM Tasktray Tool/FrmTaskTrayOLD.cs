...
{
    public partial class FrmTaskTrayOLD : Form
    {
        ...
        public FrmTaskTrayOLD()
        {
            ...
            try
            {
                DailyLoginsOLD logins = (DailyLoginsOLD)ByteArrayToObject(File.ReadAllBytes(pathDailyLoginsConfig));
