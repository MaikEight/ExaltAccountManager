...
namespace ExaltAccountManager
{
    public partial class FrmAddAccount : Form
    {
        ...
        public FrmAddAccount(FrmMainOLD _frm, bool skipTheme = false)
        {
            InitializeComponent();
            frm = _frm;
        ...
        public FrmAddAccount(FrmMainOLD _frm, MK_EAM_Lib.AccountInfo _info)
        {
            InitializeComponent();
            frm = _frm;
            info = _info;
        ...
        private void lSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (string.IsNullOrEmpty(info.name) || info.requestState != MK_EAM_Lib.AccountInfo.RequestState.Success)
                {
