...
import { EXPORT_SUCCESS_MESSAGES, MASCOT_NAME } from "../../constants";
...
function CustomToolbar({ onSearchChanged, onAddNew }) {
    ...
    const sendExportSucceededSnackbar = () => {
        const message = EXPORT_SUCCESS_MESSAGES[Math.floor(Math.random() * EXPORT_SUCCESS_MESSAGES.length)];
                    ...
                    >
                        <StyledButton
                            ...
                            onClick={async () => {
                                ...
                                const downloadsPath = await invoke('get_download_directory');
                                await invoke('open_folder_in_explorer', { path: downloadsPath });
                        ...
                        >
                            Open File in {isMac ? 'Finder' : 'Explorer'}
                        </StyledButton>
                    </Box>
                </Box>
            ),
