            ...
            <g id="图层_2" data-name="图层 2">
                <g id="Discord_Logos" data-name="Discord Logos">
                    <g id="Discord_Logo_-_Large_-_White" data-name="Discord Logo - Large - White">
                        ...
                        <ellipse fill="#fff" cx="242.92" cy="24.93" rx="8.55" ry="7.68" />
                        <path fill="#fff" d="M234.36,37.9a22.08,22.08,0,0,0,17.11,0V69.42H234.36Z" />
                    </g>
                </g>
            </g>
        </svg>
...
export default DiscordLogoFull;